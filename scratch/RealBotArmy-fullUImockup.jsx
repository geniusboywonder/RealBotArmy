...
export default function App() {
  ...
  const [chatMessages, setChatMessages] = useState([
    { id: 1, text: "[System] Agent Manager started.", time: Date.now(), type: "system" },
  ]);
  ...
  useEffect(() => {
    ...
    const logInterval = setInterval(() => {
      ...
      setChatMessages((m) => [...m, { id: Date.now(), text: msg.text, time: Date.now() }]);
    }, 8000);
              ...
              <span className="flex items-center gap-1">
                <span
                  className={`w-3 h-3 rounded-full inline-block ${
                    agents.some((a) => a.status === "error") ? "bg-red-500" : "bg-green-500"
                  }`}
                ></span>
            ...
            <div className="p-3 space-y-2">
              {navItems.map((item) => (
                ...
                >
                  ...
                  {sidebarCollapsed && (
                    <div
                      className="fixed opacity-0 group-hover:opacity-100 bg-gray-700 text-white text-sm rounded px-2 py-1 pointer-events-none transition-opacity whitespace-nowrap z-50 left-20"
                    >
                      {item.name}
                    </div>
                  )}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {agents.map((agent) => (
                      ...
                      >
                        ...
                        {agent.currentTask && (
                          <div className="mt-2">
                            <h4 className="text-xs font-medium text-gray-700 dark:text-gray-300">Task:</h4>
                        ...
                        {agent.handoff && (
                          <div className="mt-1 text-xs text-orange-500">Handing to: {agent.handoff}</div>
                        )}
